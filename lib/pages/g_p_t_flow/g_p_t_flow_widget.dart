...
class _GPTFlowWidgetState extends State<GPTFlowWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ApiKeysRecord>>(
      stream: queryApiKeysRecord(
        queryBuilder: (apiKeysRecord) =>
            apiKeysRecord.where('name', isEqualTo: 'open_ai'),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<ApiKeysRecord> gPTFlowApiKeysRecordList = snapshot.data!;
        final gPTFlowApiKeysRecord = gPTFlowApiKeysRecordList.isNotEmpty
            ? gPTFlowApiKeysRecordList.first
            : null;
                                    ...
                                    onPressed: () async {
                                      ...
                                      _model.chatGPTResponse =
                                          await OpenAIChatGPTGroup
                                              .sendFullPromptCall
                                              .call(
                                        apiKey: gPTFlowApiKeysRecord?.key,
