        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'premium')
                  : PremiumWidget(),
            ),
            FFRoute(
              name: 'doctemplates',
              path: 'doctemplates',
              builder: (context, params) => DoctemplatesWidget(),
            ),
            FFRoute(
              name: 'businessreg',
              path: 'businessreg',
              builder: (context, params) => BusinessregWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'submissions',
              path: 'submissions',
              builder: (context, params) => SubmissionsWidget(),
            ),
            FFRoute(
              name: 'businessregCopy',
              path: 'businessregdetails',
              builder: (context, params) => BusinessregCopyWidget(
                ref: params.getParam('ref', ParamType.DocumentReference, false,
                    ['business_registration']),
              ),
            ),
            FFRoute(
              name: 'businessregAdmin',
              path: 'businessregAdmin',
              builder: (context, params) => BusinessregAdminWidget(
                ref: params.getParam('ref', ParamType.DocumentReference, false,
                    ['business_registration']),
              ),
            ),
            FFRoute(
              ...
              builder: (context, params) => SubmissionsAdminWidget(),
            ),
            FFRoute(
              name: 'detailVideo',
              path: 'detailVideo',
              builder: (context, params) => DetailVideoWidget(
                image: params.getParam('image', ParamType.String),
                name: params.getParam('name', ParamType.String),
                category: params.getParam('category', ParamType.String),
                author: params.getParam('author', ParamType.String),
